            ...
            <tbody>
                ...
                foreach ($paginatedUsers as $user) { ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($user['role'] != 1) { ?>
                                <a href="admin/edit_user?id=<?= $user['role'] ?>">Modifier</a> |
                                <a href="admin/delete_user?id=<?= $user['role'] ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?')">Supprimer</a>
                            <?php } ?>
                        </td>
                    </tr>
                <?php
